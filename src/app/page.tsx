    ...
    <div className="bg-white">
      <main>
        <div className="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20 h-96">
          {/* <Image
            src="/Allo_Fill_GradientGreen.mp4"
            alt=""
          ...
          <video
            ...
            className="absolute inset-0 -z-10 h-full w-full object-cover"
          >
            <source src="/Allo_Fill_GradientGreen.mp4" type="video/mp4" />
          </video>
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl py-2 sm:py-8 lg:py-6">
              <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-green-400 ring-1 ring-white/10 hover:ring-white/20">
              ...
              <div className="text-center">
                <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl">
                  <span className="block">
                    Allo data to enrich your funding programs
                  </span>
                </h1>
